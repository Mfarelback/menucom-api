  ...
  try {
    ...
    for (const user of eventOrganizers.rows) {
      ...
      if (existing.rows.length === 0) {
        ...
        console.log(
          `  ✅ Migrated event organizer: ${user.email} (${user.name})`,
        );
        migratedCount++;
      } else {
    ...
    console.log(
      `   Phase 1 complete: ${migratedCount} migrated, ${skippedCount} skipped\n`,
    );
    migratedCount = 0;
    skippedCount = 0;
    ...
    for (const user of restaurantOwners.rows) {
      ...
      if (existing.rows.length === 0) {
        ...
        console.log(
          `  ✅ Migrated restaurant owner: ${user.email} (${user.name})`,
        );
        migratedCount++;
      } else {
        console.log(`  ⏭️  Skipped (already has role): ${user.email}`);
    ...
    console.log(
      `   Phase 2 complete: ${migratedCount} migrated, ${skippedCount} skipped\n`,
    );
    migratedCount = 0;
    skippedCount = 0;
    ...
    for (const user of wardrobeOwners.rows) {
      ...
      if (existing.rows.length === 0) {
        ...
        console.log(
          `  ✅ Migrated wardrobe owner: ${user.email} (${user.name})`,
        );
        migratedCount++;
      } else {
        console.log(`  ⏭️  Skipped (already has role): ${user.email}`);
    ...
    console.log(
      `   Phase 3 complete: ${migratedCount} migrated, ${skippedCount} skipped\n`,
    );
    migratedCount = 0;
    skippedCount = 0;
    ...
    for (const user of marketplaceOwners.rows) {
      ...
      if (existing.rows.length === 0) {
        ...
        console.log(
          `  ✅ Migrated marketplace owner: ${user.email} (${user.name})`,
        );
        migratedCount++;
      } else {
        console.log(`  ⏭️  Skipped (already has role): ${user.email}`);
    ...
    console.log(
      `   Phase 4 complete: ${migratedCount} migrated, ${skippedCount} skipped\n`,
    );
    migratedCount = 0;
    skippedCount = 0;
    ...
    console.log(
      `   Phase 5 complete: ${migratedCount} migrated, ${skippedCount} skipped\n`,
    );
