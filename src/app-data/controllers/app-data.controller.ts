...
export class AppDataController {
  ...
  @ApiOperation({
    summary: 'Crear un nuevo dato de configuración (Solo Administradores)',
    description:
      'Crea un nuevo dato de configuración con una clave única y su valor correspondiente. Requiere permiso MANAGE_USERS.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiBearerAuth('JWT-auth')
  @ApiOperation({
    summary: 'Actualizar un dato de configuración (Solo Administradores)',
    description:
      'Actualiza un dato de configuración existente por su ID. Requiere permiso MANAGE_USERS.',
  })
  @ApiParam({
    name: 'id',
    description: 'ID del dato de configuración',
  ...
  @ApiOperation({
    summary:
      'Activar/Desactivar un dato de configuración (Solo Administradores)',
    description:
      'Cambia el estado activo/inactivo de un dato de configuración. Requiere permiso MANAGE_USERS.',
  })
  @ApiParam({
    name: 'id',
    description: 'ID del dato de configuración',
  ...
  @ApiBearerAuth('JWT-auth')
  @ApiOperation({
    summary: 'Eliminar un dato de configuración (Solo Administradores)',
    description:
      'Elimina permanentemente un dato de configuración por su ID. Requiere permiso MANAGE_USERS.',
  })
  @ApiParam({
    name: 'id',
    description: 'ID del dato de configuración',
  ...
  @ApiOperation({
    summary:
      'Configurar el porcentaje de comisión del marketplace (Solo Administradores)',
    description:
      'Configura el porcentaje de comisión que cobra el marketplace por cada transacción. Requiere permiso MANAGE_USERS.',
  })
  @ApiResponse({
    status: 200,
